    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("Los errores que encontre en la classe persona es que necesitas crear otras personas para creare una persona y necesitas crear una adress para que tambien toma una persona");
                Console.WriteLine("=========================================");
                ...
                Console.WriteLine("ingrese 1 si quiere cambiar su primer nombre, ingrese 2 si quiere cambiar su apellido, ingrese 3 si se quiere abandonarse, ingrese 4 para ser adoptado, ingrese 5 para regalar tus cosas a otra persona, ingrese 6 para ingresar una educacion, ingrese 7 para ingresar auto, ingrese 9 para meterse a las opciones de su vivienda, ingrese 10 para meterse a las opciones de su auto:");
                opcion = Convert.ToInt32(Console.ReadLine());
                if (opcion == 1)
                {
